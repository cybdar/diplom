...
public class TestData {
    ...
    public static final String TITLE = "Автотест";
    public static final String DESCRIPTION = "Новость создана автоматическим тестом";
    public static final String DATE = "22.08.2026";
